...
createAction = createAction;var _index = require('./index');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function isFunction(thing) {return typeof thing === 'function';}function checkAsyncHandlers(handlers) {var onWait = handlers.onWait;var onSuccess = handlers.onSuccess;var onFail = handlers.onFail;var errMessage = function errMessage(fnName) {return 'Expected that the ' + fnName + ' will be a function, and will returns new state';};if (!isFunction(onWait)) {throw new Error(errMessage('onWait'));}if (!isFunction(onSuccess)) {throw new Error(errMessage('onSuccess'));}if (!isFunction(onFail)) {throw new Error(errMessage('onFail'));}} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  *
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  * @param {String} name
