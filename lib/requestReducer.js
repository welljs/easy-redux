...
function applyRequestReducers(storeKey, data, replace) {
    ...
    return easy_redux_1.applyReducer(storeKey, easy_redux_1.localCompose.apply(void 0, reducers), replace);
}
exports.applyRequestReducers = applyRequestReducers;
function createRequestReducer(store) {
    appStore = store;
}
exports.createRequestReducer = createRequestReducer;
function requestReducer(key) {
    return {
        submit: function () {
            var _a;
            if (!cache[key]) {
